...
| --- | ---: | --- |
| standalone | 1265 | all component tests outside the provider-contract/simulation, egress, and family partitions; every selected identity executes with zero skipped, including the explicitly feature-enabled verifier fixture tests |
...
| total | 1311 | exact union of the four disjoint partitions above |
...
| Lane | Scope |
| --- | --- |
| `fast` | exactly 1265 standalone nextest identities, all executed with zero skipped |
