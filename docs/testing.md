...
| --- | ---: | --- |
| standalone | 523 | all component tests outside the provider-contract/simulation, egress, and family partitions; every selected identity executes with zero skipped |
...
| total | 569 | exact union of the four disjoint partitions above |
...
| Lane | Scope |
| --- | --- |
| `fast` | exactly 523 standalone nextest identities, all executed with zero skipped |
