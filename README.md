...
| --- | --- | --- | --- |
| fast | `just fast` | digest-bound 502-test standalone partition: 499 execute and three exact live-egress cases stay explicitly ignored; a checked nonexistent daemon sentinel prevents sibling fallback | `COMPONENT_PROOF` |
